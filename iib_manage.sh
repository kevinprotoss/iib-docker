...
SECURITYIDENTITY_NAME =${SECURITYIDENTITY_NAME-default}
SECURITYIDENTITY_USERNAME =${SECURITYIDENTITY_USERNAME-username}
SECURITYIDENTITY_PASSWORD =${SECURITYIDENTITY_PASSWORD-password}
